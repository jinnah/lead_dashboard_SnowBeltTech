...
select is((select count(*) from pg_policies where schemaname = 'public'), 9::bigint,
  'exactly the 9 expected policies exist (7 Batch 1 + ingestion_events + lead_activities select)');
