...
select is((select count(*) from pg_proc p join pg_namespace n on n.oid = p.pronamespace where n.nspname = 'public'), 16::bigint, 'public RPC inventory with invitation reissue (16)');
