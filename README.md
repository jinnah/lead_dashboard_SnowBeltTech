...
4. **Customer portal** — real Supabase Auth sign-in, customer dashboard with audited status/follow-up/notes/assignment, local password recovery, read-only admin overview and lead inspection (implemented locally); export pending.
